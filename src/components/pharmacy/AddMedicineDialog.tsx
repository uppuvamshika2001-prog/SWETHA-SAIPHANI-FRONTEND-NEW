    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const medicinePayload = {
                ...
                stock_quantity: parseInt(formData.stock_quantity) * (parseInt(formData.pack_quantity) || 1),
                pack_quantity: formData.pack_quantity !== "" ? parseInt(formData.pack_quantity) : 1,
                free_quantity: (parseInt(formData.free_quantity) || 0) * (parseInt(formData.pack_quantity) || 1),
                ptr: formData.ptr !== "" ? parseFloat(formData.ptr) : 0,
                taxable_amount: taxableAmount,
                gst_amount: gstAmount,
                total_amount: totalAmount,
                reorder_level: (formData.min_stock_level !== "" ? parseInt(formData.min_stock_level) : 10) * (parseInt(formData.pack_quantity) || 1),
